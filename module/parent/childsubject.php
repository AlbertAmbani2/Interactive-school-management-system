    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 text-center mt-5">
                ...
                <h2>Select Class:</h2>
                <select id="myclass" name="myclass" onchange="ajaxRequestToGetSubject();" class="form-control">
                </select>

                <h2>Select Subject:</h2>
                <select id="mycourse" onchange="ajaxRequestToGetCourseInfo();" name="mycourse" class="form-control">
                </select>

                <h4>Subject Information:</h4>
                <hr/>
                <label id="mycourseteacher"></label><br/>
                <table id="mycourseinfo" class="table">
                </table>
                <hr/>
            </div>
        </div>
